...
import { System_Bigint } from './SystemBigInt.js';
import { System_Convert } from './SystemConvert.js';
import { System_Security_Cryptography } from './SystemSecurityCryptography.js';
import { System_Security_Cryptography_SHA1 } from './SystemSecurityCryptographySHA1.js';


System.Type.RegisterNamespace("System.Security.Cryptography");
System.BigInt = System_Bigint;
System.Text = System_Text;
System.System_Convert = System_Convert;
System.Security = {};
System.Security.Cryptography = System_Security_Cryptography;
System.Security.Cryptography.PaddingMode = System_Security_Cryptography.PaddingMode;
System.Security.Cryptography.CipherMode = System_Security_Cryptography.CipherMode;
...
System.Security.Cryptography.RSACryptoServiceProvider = function () {
	...
	function Padding(input, fOAEP, encrypt) {
		//console.log("function Padding fOAEP:", fOAEP);
		//console.log(" System.Security.Cryptography.PaddingMode:",  System.Security.Cryptography.PaddingMode);
		this.Padding = fOAEP
	...
	function RsaEncryptBlock(block, key) {
		//console.log("RsaEncryptBlock block:", block);
		//var mBytes = block.Clone();
		var mBytes = block.slice(0);
		//console.log("RsaEncryptBlock mBytes:", mBytes);
